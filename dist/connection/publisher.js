...
},{"../utils":"utils.ts"}],"connection/publisher.ts":[function(require,module,exports) {
"use strict";
...
var ConnectionPublisher =
/** @class */
function (_super) {
  __extends(ConnectionPublisher, _super);

  function ConnectionPublisher() {
    return _super !== null && _super.apply(this, arguments) || this;
  }

  ConnectionPublisher.prototype.connect = function (stream) {
    this.role = 'upstream';
  ...
  ConnectionPublisher.prototype.singleStream = function (stream) {
    var _this = this;
  ...
  ConnectionPublisher.prototype.multiStream = function (stream) {
    var _this = this;
    ...
    return this.disconnect().then(this.createOffer).then(this.signaling).then(this.connectPeerConnection).then(function (message) {
      ...
      if (typeof _this.pc.ontrack === 'undefined') {
        _this.pc.onaddstream = function (event) {
          if (_this.clientId !== event.stream.id) {
...
exports.default = ConnectionPublisher;
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","connection/publisher.ts"], null)
